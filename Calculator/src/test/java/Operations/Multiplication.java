...
public class Multiplication {
	...
	public Multiplication(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void multiply() throws InterruptedException {
		...
		WebElement canvas = new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(By.id("canvas")));
			...
			Thread.sleep(2000);
			//clicking on the multiplication sign (*)
			new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset((174/5)*3,(255/6)).click().build().perform();
			Thread.sleep(2000);
			//clicking on 1
...
public void multiply_negative() throws InterruptedException {
